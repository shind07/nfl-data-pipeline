...
ARCHIVE_CSV_NAME = os.path.join(PLAY_BY_PLAY_DIRECTORY, f"1999_{CURRENT_YEAR - 1}.csv")
...
def run(backfill: bool = False) -> None:
    ...
    if backfill:
        ...
        merge_csvs(historic_csvs, ARCHIVE_CSV_NAME)
    ...
    if backfill:
        ...
        merge_csvs([ARCHIVE_CSV_NAME, current_local_path], all_local_path)
